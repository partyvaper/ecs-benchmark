...
export default (count) => {
    ...
    world.registerSystem(ABSystem).registerSystem(CDSystem).registerSystem(CESystem);

    for (let i = 0; i < count; i++) {
        world.createEntity().addComponent(A, { value: 0 }).addComponent(B, { value: 1 });
        world.createEntity().addComponent(A, { value: 0 }).addComponent(B, { value: 1 }).addComponent(C, { value: 2 });
        world
            .createEntity()
